...
<div style="padding-bottom: 5px;width: 183px;border-bottom: 1px solid black;">
<p id="mob-fname" style="margin: 0;text-align: center;color:#737f8a;padding: 0;font-size: 15px;"></p>
<p id="mob-email" style="margin: auto;width: 100%;color:#737f8a;overflow: hidden;font-size: 18px;display: block;white-space: nowrap;text-overflow: ellipsis;padding: 0;"></p>
</div>
<ul class="mob-menu-ul" style="list-style: none;display: flex;flex-wrap: wrap;justify-content: center;align-items: center;">
...
<div id="top-menu-mobile">
   ...
   <li class="moduleMenu"><a class="page-unique homepageMenu" href="index.php">Home</a></li>
	 ...
	 <div> 
	 <li class="moduleMenu loginbt" data-menu-module-id="5b0a4ba521825"><a style="margin-right: 7px;font-weight: bold;" class="page-unique gotoLogin" href="#" onclick="document.location.href='index4cd7.php#login'">Login</a></li>
	  <li class="moduleMenu signup" data-menu-module-id="5b0a4ba521825" style=""><a style="color:white !important;" class="page-unique gotoRegister" onclick="document.location.href='index4cd7.php#register'" href="#">Sign Up</a></li>
	 </div>
	</ul>
</div>
</div>
<!-- <div id="top-menu-mobile"  style="display:none;">
   <ul class="lm1">
      ...
      <li class="moduleMenu" data-menu-module-id="5d985dca46598"><a class="page-unique" href="tracker.php"><span class="txt-container">Tracker</span></a></li>
	  <li class="moduleMenu loginbt" data-menu-module-id="5b0a4ba521825"><a style="margin-right: 7px;font-weight: bold;" class="page-unique gotoLogin" href="#" onclick="document.location.href='index4cd7.php#login'">Login</a></li>
	  <li class="moduleMenu signup" data-menu-module-id="5b0a4ba521825" style="padding:6px !important;padding-top:4px !important;padding-bottom:4px !important;width:50%;margin:auto;"><a style="color:white !important;" class="page-unique gotoRegister" onclick="document.location.href='index4cd7.php#register'" href="#">Sign Up</a></li>
            ...
            <div class="container">
               <div class="row modulesTitle">
                  <div class="col-xs-12 text-center" style='display:none;'>
                     <H1 id="section--title" class="s123-page-header">Reset Password</H1>
                     <hr class="small">
            ...
            <form id="clientLoginForm" class="text-center" style='display:none;'>
				<div class="row page-loading-icon text-center" style="display: none;z-index:1000;background: transparent;position: absolute;top: 50%;left: 53%;transform: translate(-50%,-50%);"> <i class="ace-icon fa fa-spinner fa-spin blue fa-4x"></i> </div>
				 ...
				 <div class="form-group">
                     ...
                     <div class="form-group">
						<h3 class="formh3">ReEnter Password</h3>
						<hr class="form3hr">
						<div class="input-group" id="show_hide_password2" style="margin: 0 auto;">
							<input type="password" id="reclientPassword" name="reclientPassword" value="" class="form-control" placeholder="Password" style="max-width: 270px;/* margin: 0 auto; */margin: 0;/* margin-left: auto; */margin-top:10px;" required data-msg-required="Please enter your password"/>
							<div class="input-group-addon" style="background:transparent;">
									<a href=""><i class="fa fa-eye-slash" aria-hidden="true" style="color:rgba(0,0,0,0.82);"></i></a>
								</div>
						</div>
...
<script>var translations = {
	...
	jQuery(function($) {
function showEror(msg1,msg2){
    $('.s123-client-zone-page .row').eq(2).css('position','relative');
    $('.s123-client-zone-page .row').eq(2).css('height','400px');
    $('.terminal').show();

    var text_1 = msg1,
        text_2 = msg2;
        writer(text_1,text_2);
    }
function writer(text_1,text_2){
repeat(text_1, 1);
setTimeout(function() {
	repeat(text_2, 2);
}, text_1.length * 100 + 1000);
setTimeout(function() {
	repeatReverse(text_2, 2);
}, (text_1.length+text_2.length) * 100 + 6000);
setTimeout(function() {
	repeatReverse(text_1, 1);
}, (text_1.length+(2*(text_2.length))) * 100 + 7000);
setTimeout(function() {
	writer(text_1,text_2);
}, 2 * (text_1.length+text_2.length) * 100 + 9000);
...
function repeatReverse(text, n) {
		var i = text.length-1,
				repeatable = setInterval(function() {
                    if (i <0) {
								clearInterval(repeatable);
						}
						$('#text_'+n).text(text.substring(0,i));
						i--;
        ...
        if(hash.length==0){
            ...
            $('#pgload').hide();
            showEror("This link is broken or unidentified...","Please visit the home page...Wasche");
        ...
        if(hash.length==32){
            ...
            showEror("There seems to be an internal error... ","Please visit the home page...Wasche");
						}
					},
