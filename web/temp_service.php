...
<head><meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <!-- Regular Meta Info -->
    <title class="s123-js-pjax">Services - Wasche</title>
				...
				<nav id="mainNav" class="hidden-xs navbar-default navbar-fixed-top  opacity-full"> 
					<div class="site_container"> 
						...
						<ul class="navPages nav navbar-nav lt1"> 
							...
							<li class="moduleMenu active" data-menu-module-id="5d0a0f53588b1">
...
<ul class="mob-menu-ul" style="list-style: none;display: flex;flex-wrap: wrap;justify-content: center;align-items: center;box-shadow:0 6px 18px rgba(0,0,0,0.3);">
...
<div id="s123PjaxMainContainer">
   ...
   <div class="breadcrumb-wrap" style="background:#353b43 !important;" >
            <ol class="breadcrumb container" style="padding-top:20px;background:#353b43 !important;">
               <li><a class="homepageMenu" href="index.php">Home</a></li>
               <li class="active" style="color:#fff">Services</li>
            </ol>
         </div>
   <section id="pricing" style="background:#353b43 !important;padding-top:20px" class="pricing section">
				...
				<div id="testimonials" class="wow fadeInUp" data-wow-duration="500ms" data-wow-delay="100ms">
					...
					<div class="item text-center">
						...
						<div class="client-thumb">
							<img src="./images/team/client-1.jpg" style="position:relative;" class="img-responsive" alt="Meghna">
						</div>
						<!-- /client photo -->
					...
					<div class="item text-center">
						...
						<!-- client photo -->
						<div class="client-thumb">
							<img src="./images/team/client-2.jpg" style="position:relative;" class="img-responsive" alt="Meghna">
						</div>
						<!-- /client photo -->
					...
					<div class="item text-center">
						...
						<!-- client photo -->
						<div class="client-thumb">
							<img src="./images/team/client-1.jpg" class="img-responsive" style="position:relative;" alt="Meghna">
						</div>
						<!-- /client photo -->
...
<section id="contact-us" style="background:#353b43 !important;" class="custom contact-us section-bg">
	<div class="container">
		<div class="row">
