               ...
               <div class="container">
                  <div class="row modulesTitle">
                     <div class="col-xs-12 text-center">
                        <H1 id="section-5b0a4ba50e4e8-title" class="s123-page-header">About</H1>
                        <hr class="small">
            ...
            <div class="row">
               <div class='col-xs-12'>
                  <div class="responsive-handler fr-view breakable">
                     <div class="images">
                        <div class="separateImages text-center"> <img src="./cdn-cms.f-static.com/uploads/2630165/800_5d0a171177656.jpg" class="img-rounded img-responsive" style="max-height:400px;max-width:80%;display:inline-block;" alt="About" /> </div>
                     </div>
                     Need to write.
                  </div>
               </div>
