    ...
    <div class="body">
        ...
        <div id="s123PjaxMainContainer">
            ...
            <section id="section-5b0a4ba50e4e8" class="s123-module s123-module-about layout-4 layout-4">
                ...
                <section id="section-5d98551546595" class="s123-module s123-module-pricing-tables layout-1 bg-primary">
                    <div data-aos="fade-up" class="container-fluid page_header_style page_header_style_">
                        <div class="row">
                            <div class="container">
                                <div class="row modulesTitle">
                                    <div class="col-xs-12 text-center">
                                        <H2 id="section-5d98551546595-title" class="s123-page-header">Pricing Table</H2>
                                        <hr class="small">
                                        <h4 id="section-5d98551546595-slogan"></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container" data-aos="fade-up">
                        <div style="display:flex;justify-content:center;flex-wrap: wrap;align-content: center;align-items: center;" class="row pricing-m text-center">
                            <div style="margin:auto;float:none;padding-top:1rem;" class="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-2">
                                <div style="margin: 0;float:none;height:auto;padding:1rem;" class="pricing-m-box pricing-m-popular">
                                    <div class="pricing-m-title">
                                        <h3>Basic</h3>
                                        <span>Most Popular</span>
                                    </div>
                                    <div class="pricing-m-price" style="color:#019875">
                                        <span class="pricing-m-price-value">&#8377;</span>780<span class="pricing-m-price-period">/Month</span>
                                    </div>
                                    <div class="pricing-m-features">
                                        <ul>
                                            <li>aaaa</li>
                                        </ul>
                                    </div>
                                    <div class="pricing-m-action">
                                        <a class="btn btn-primary btn-block btn-xl order-pricing-table-btn" data-module="5d98551546595" data-unique-page="5d9854cd99da3" data-tranw="">Order Now</a>
                                    </div>
                                </div>
                            </div>
                            <div style="margin:auto;float:none;padding-top:1rem;" class="col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0">
                                <div style="margin: 0;float:none;height:auto;padding:1rem;" class="pricing-m-box pricing-m-popular">
                                    <div class="pricing-m-title">
                                        <h3>Premium</h3><span>Most Popular</span>
                                    </div>
                                    <div class="pricing-m-price" style="color:#019875">
                                        <span class="pricing-m-price-value">&#8377;</span>9500<span class="pricing-m-price-period">/Year</span>
                                    </div>
                                    <div class="pricing-m-features">
                                        <ul>
                                            <li>sadasd</li>
                                    ...
                                    <div class="pricing-m-action">
                                        <a class="btn btn-primary btn-block btn-xl order-pricing-table-btn" data-module="5d98551546595" data-unique-page="5d9854cda1648" data-tranw="">Order Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section id="section-5d985d7c46596" class="s123-module s123-module-testimonials layout-1">
                    <div data-aos="fade-up" class="container-fluid page_header_style page_header_style_">
                        <div class="row">
                            <div class="container">
                                <div class="row modulesTitle">
                                    <div class="col-xs-12 text-center">
                                        <H2 id="section-5d985d7c46596-title" class="s123-page-header">Testimonials</H2>
                                        <hr class="small">
                                        <h4 id="section-5d985d7c46596-slogan"></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container" data-aos="fade-up">
                        ...
                        <!-- Items Area -->
                        <div class="row">
                            <div class="col-xs-12 testimonials-category" data-categories-filter="s123-g-show-all">
                                <div data-ride="carousel" class="carousel slide">
                                    ...
                                    <a href="javascript:void(0);" class="carousel-control left"><i class="fa fa-chevron-left"></i></a><a href="javascript:void(0);" class="carousel-control right"><i class="fa fa-chevron-right"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <!-- /.container -->
                </section>
                <section id="section-5d985d9a46597" class="s123-module s123-module-team layout-2 bg-primary">
                    <div data-aos="fade-up" class="container-fluid page_header_style page_header_style_">
                        <div class="row">
                            <div class="container">
                                <div class="row modulesTitle">
                                    <div class="col-xs-12 text-center">
                                        <H2 id="section-5d985d9a46597-title" class="s123-page-header">Team</H2>
                                        <hr class="small">
                                        <h4 id="section-5d985d9a46597-slogan"></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="display:flex;flex-wrap:wrap;justify-content: center;" class="row text-center team-category" data-categories-filter="s123-g-show-all">
                            ...
                            <!-- <div style="margin: auto;width:auto;" class="col-md-3 col-sm-6 team-member-wrap col-centered">
                                <div class="team-member" style="width: 300px;">
                                    ...
                                    <div class="team-details">
                                        <div>
                                            <h4 class="member-name">Jennifer Smith</h4>
                                        </div>
                                        <div>
