		...
		<div id="efmsglog" style="display:none">
			...
			<form id="clientLoginForm" class="text-center" style="display:none">
               ...
               <div class="form-group">
				   ...
				   <hr class="form3hr">
					<input type="email" id="clientEmail" name="clientEmail" value="" class="form-control" placeholder="example@example.com" style="max-width:310px;margin: 0 auto;" required data-msg-required="Please enter your email"/> 
				 </div>
